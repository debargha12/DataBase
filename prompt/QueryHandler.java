...
import chakri.model.Operator;
import chakri.query.impl.CreateDatabaseQuery;
import chakri.query.impl.CreateTableQuery;
import chakri.query.impl.DeleteQuery;
import chakri.query.impl.DescTableQuery;
import chakri.query.impl.DropDatabaseQuery;
import chakri.query.impl.DropTableQuery;
import chakri.query.impl.InsertQuery;
import chakri.query.impl.SelectQuery;
import chakri.query.impl.ShowDatabaseQuery;
import chakri.query.impl.ShowTableQuery;
import chakri.query.impl.UpdateQuery;
import chakri.query.impl.UseDatabaseQuery;
...
public class QueryHandler {
    ...
    public static String ActiveDatabaseName = "user_data";
    ...
    static void HelpQueryHandler() {
        ...
        System.out.println();
        System.out.println("\tCREATE INDEX index_name;                         Creates an empty database.");
        System.out.println("\tSHOW DATABASES;                                  Displays all databases.");
        System.out.println("\tDROP INDEX index_name;                           Deletes index");
